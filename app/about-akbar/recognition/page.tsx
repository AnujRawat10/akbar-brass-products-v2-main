      ...
      <div className="container mx-auto px-6">
        ...
        <div className="mb-16 text-center max-w-4xl mx-auto">
          <div className="flex justify-center mb-6">
            <div className="inline-flex h-20 w-20 items-center justify-center rounded-full text-white" style={{ backgroundColor: '#521C0D' }}>
          ...
          <p className="mt-4 text-base leading-relaxed" style={{ color: '#521C0D', opacity: 0.8 }}>
        ...
        <div className="grid gap-12 md:grid-cols-1 lg:grid-cols-1 max-w-5xl mx-auto mb-16">
          {awards.map((award, index) => (
            <div key={index} className="rounded-lg overflow-hidden hover:shadow-lg transition-shadow" style={{ backgroundColor: 'white' }}>
              <div className="aspect-[4/3] overflow-hidden" style={{ backgroundColor: '#EDE8D0' }}>
                <img src={award.image || "/placeholder.svg"} alt={award.title} className="w-full h-full object-contain" />
              </div>
              <div className="p-8">
                <h3 className="text-2xl font-bold mb-3" style={{ color: '#521C0D' }}>{award.title}</h3>
                <p className="text-sm mb-2" style={{ color: '#521C0D', opacity: 0.8 }}><strong>Presented By:</strong> {award.presentedBy}</p>
                <p className="text-sm mb-4" style={{ color: '#521C0D', opacity: 0.8 }}><strong>Issued By:</strong> {award.issuedBy}</p>
                <p className="leading-relaxed" style={{ color: '#521C0D' }}>{award.description}</p>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="p-8 rounded-lg text-center max-w-4xl mx-auto mb-16" style={{ backgroundColor: 'white' }}>
          <p className="leading-relaxed" style={{ color: '#521C0D' }}>
