    ...
    <div className="min-h-screen pt-24 pb-16" style={{ backgroundColor: '#f0efe2' }}>
      <div className="container mx-auto px-6 max-w-5xl">
        ...
        <div className="mb-16 text-center">
          <h1
            className="mb-6 font-serif text-4xl font-bold md:text-5xl"
            style={{ color: '#63403A' }}
          >
            Timeline
          </h1>
          ...
          >
            ...
            from traditional craftsmanship to modern, system-driven manufacturing.
            Each decade shows how we expanded our material expertise, upgraded our
            processes, and consolidated our infrastructure to meet the expectations
            of global markets.
          </p>
        </div>
          ...
          <div className="space-y-12">
            {milestones.map((milestone, index) => (
              <div key={index} className="relative flex items-start md:justify-between">
                ...
                {/* Icon */}
                <div
                  className="absolute left-0 flex h-16 w-16 items-center justify-center rounded-full text-white md:left-1/2 md:-translate-x-1/2 z-10"
                ...
                >
                  <div className="p-6 rounded-lg bg-white">
                    <div className="text-2xl font-bold mb-2" style={{ color: '#63403A' }}>
                      {milestone.year}
                    </div>
