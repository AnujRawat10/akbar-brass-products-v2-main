...
export default function EthicsPage() {
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#EDE8D0' }}>
      <section className="px-6 py-24 md:py-32 text-white" style={{ backgroundColor: '#521C0D' }}>
      ...
      <section className="px-6 py-16 md:py-24 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-16">
            <h2 className="mb-4 font-serif text-3xl font-bold text-center md:text-4xl" style={{ color: '#521C0D' }}>Certifications</h2>
            <p className="text-lg text-center max-w-3xl mx-auto" style={{ color: '#521C0D', opacity: 0.8 }}>
              Maintaining the highest standards of quality and compliance
            </p>
          </div>

          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            <div className="p-8 bg-white rounded-lg text-center" style={{ border: '1px solid #521C0D' }}>
              <div className="mb-4 inline-flex h-16 w-16 items-center justify-center rounded-full" style={{ backgroundColor: '#521C0D' }}>
                <Shield className="h-8 w-8 text-white" />
              </div>
              <h3 className="mb-2 font-bold text-xl" style={{ color: '#521C0D' }}>SEDEX</h3>
              <p className="text-sm" style={{ color: '#521C0D', opacity: 0.8 }}>Ethical trade certification</p>
            </div>
            ...
            <div className="p-8 bg-white rounded-lg text-center" style={{ border: '1px solid #521C0D' }}>
              ...
              <h3 className="mb-2 font-bold text-xl" style={{ color: '#521C0D' }}>UL</h3>
              <p className="text-sm" style={{ color: '#521C0D', opacity: 0.8 }}>Safety certification for electrical products</p>
            </div>
            ...
            <div className="p-8 bg-white rounded-lg text-center" style={{ border: '1px solid #521C0D' }}>
              ...
              <h3 className="mb-2 font-bold text-xl" style={{ color: '#521C0D' }}>CE</h3>
              <p className="text-sm" style={{ color: '#521C0D', opacity: 0.8 }}>European conformity standards</p>
            </div>
            ...
            <div className="p-8 bg-white rounded-lg text-center" style={{ border: '1px solid #521C0D' }}>
              ...
              <h3 className="mb-2 font-bold text-xl" style={{ color: '#521C0D' }}>ISO</h3>
              <p className="text-sm" style={{ color: '#521C0D', opacity: 0.8 }}>International quality management</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="px-6 py-16 md:py-24">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12">
            <h2 className="mb-4 font-serif text-3xl font-bold text-center md:text-4xl" style={{ color: '#521C0D' }}>Our Commitments</h2>
          </div>

          <div className="grid gap-8 md:grid-cols-2">
            <div className="p-8 bg-white rounded-lg">
              <h3 className="mb-4 font-serif text-2xl font-bold" style={{ color: '#521C0D' }}>Ethical Manufacturing</h3>
              <p className="leading-relaxed mb-4" style={{ color: '#521C0D', opacity: 0.8 }}>
                We maintain the highest standards of workplace ethics and employee welfare:
              </p>
              <ul className="space-y-2" style={{ color: '#521C0D', opacity: 0.8 }}>
            ...
            <div className="p-8 bg-white rounded-lg">
              <h3 className="mb-4 font-serif text-2xl font-bold" style={{ color: '#521C0D' }}>Environmental Responsibility</h3>
              <p className="leading-relaxed mb-4" style={{ color: '#521C0D', opacity: 0.8 }}>
            ...
            <div className="p-8 bg-white rounded-lg">
              <h3 className="mb-4 font-serif text-2xl font-bold" style={{ color: '#521C0D' }}>Quality Assurance</h3>
              <p className="leading-relaxed mb-4" style={{ color: '#521C0D', opacity: 0.8 }}>
            ...
            <div className="p-8 bg-white rounded-lg">
              <h3 className="mb-4 font-serif text-2xl font-bold" style={{ color: '#521C0D' }}>Customer Excellence</h3>
              <p className="leading-relaxed mb-4" style={{ color: '#521C0D', opacity: 0.8 }}>
      ...
      <section className="px-6 py-16 md:py-24 bg-white">
        <div className="mx-auto max-w-4xl text-center">
          <h2 className="mb-6 font-serif text-3xl font-bold md:text-4xl" style={{ color: '#521C0D' }}>Global Compliance</h2>
          <p className="text-lg leading-relaxed mb-8" style={{ color: '#521C0D', opacity: 0.8 }}>
          ...
          <p className="text-lg leading-relaxed" style={{ color: '#521C0D', opacity: 0.8 }}>
