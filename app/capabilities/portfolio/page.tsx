    ...
    <div className="min-h-screen bg-[#f0efe2]">
     ...
     <main >
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center gap-3 mb-6">
                  <Sofa className="w-10 h-10 text-[#63403A]" />
                  <h2 className="text-3xl font-bold text-[#63403A]">Furniture</h2>
                </div>
          ...
          <div className="container mx-auto px-4">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-1 md:order-2">
                <div className="flex items-center gap-3 mb-6">
                  <Home className="w-10 h-10 text-[#63403A]" />
                  <h2 className="text-3xl font-bold text-[#63403A]">Home Décor</h2>
                </div>
                <p className="text-[#63403A] opacity-80 mb-6">
                ...
                <div>
                  <h3 className="font-semibold text-[#63403A] mb-3">Categories include:</h3>
                  <ul className="list-disc list-inside text-[#63403A] opacity-80 space-y-2">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="text-3xl font-bold text-[#63403A]">Kitchen, Serveware & Barware</h2>
                </div>
                <p className="text-[#63403A] opacity-80 mb-6">
        ...
        <section className="py-16 bg-white border-b border-[#63403A] border-opacity-20">
          <div className="container mx-auto px-4">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-1 md:order-2">
                <div className="flex items-center gap-3 mb-6">
                  <Lightbulb className="w-10 h-10 text-[#63403A]" />
                  <h2 className="text-3xl font-bold text-[#63403A]">Lighting</h2>
                </div>
                <p className="text-[#63403A] opacity-80 mb-6">
                  Our lighting products combine metal fabrication, clean finishing, and electrical safety requirements.
                </p>
                <div className="mb-6">
                  <h3 className="font-semibold text-[#63403A] mb-3">We manufacture:</h3>
                  <ul className="list-disc list-inside text-[#63403A] opacity-80 space-y-2">
                    <li>Table lamps</li>
                    <li>Floor lamps</li>
        ...
        <section className="py-16 border-b border-[#63403A] border-opacity-20">
          <div className="container mx-auto px-4">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center gap-3 mb-6">
                  <TreesIcon className="w-10 h-10 text-[#63403A]" />
                  <h2 className="text-3xl font-bold text-[#63403A]">Outdoor & Garden</h2>
                </div>
                <p className="text-[#63403A] opacity-80 mb-6">
                  Outdoor products are developed using weather-resistant processes and durable material combinations.
                </p>
                <div className="mb-6">
                  <h3 className="font-semibold text-[#63403A] mb-3">Portfolio includes:</h3>
                  <ul className="list-disc list-inside text-[#63403A] opacity-80 space-y-2">
        ...
        <section className="py-16 bg-white border-b border-[#63403A] border-opacity-20">
          <div className="container mx-auto px-4">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-1 md:order-2">
                <div className="flex items-center gap-3 mb-6">
                  <Gift className="w-10 h-10 text-[#63403A]" />
                  <h2 className="text-3xl font-bold text-[#63403A]">Festive & Seasonal</h2>
                </div>
                <p className="text-[#63403A] opacity-80 mb-6">
                ...
                <div className="mb-6">
                  <h3 className="font-semibold text-[#63403A] mb-3">Key Programs:</h3>
                  <p className="text-[#63403A] opacity-80">
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold text-[#63403A] mb-4">Explore Our Product Gallery</h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link 
                href="/login"
                className="inline-flex items-center justify-center px-8 py-3 bg-[#63403A] text-white hover:bg-[#63403A] hover:opacity-90 transition-all rounded"
              >
                Login to Product Gallery
              </Link>
              <Link 
                href="/contact"
                className="inline-flex items-center justify-center px-8 py-3 bg-white text-[#63403A] border-2 border-[#63403A]  transition-all rounded"
              >
