        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="flex items-center gap-3 mb-12">
              <Briefcase className="w-8 h-8 text-[#521C0D]" />
              <h2 className="text-3xl font-bold text-[#521C0D]">Current Openings</h2>
            </div>

            <div className="space-y-8">
              {jobOpenings.map((job, index) => (
                <div key={index} className="bg-white border border-[#521C0D] border-opacity-20 rounded-lg overflow-hidden">
                  {/* Job Title Header */}
                  <div className="bg-[#521C0D] text-white px-6 py-4">
                  ...
                  <div className="p-6">
                    <div className="grid md:grid-cols-2 gap-8">
                      ...
                      <div>
                        <div className="mb-6">
                          <h4 className="font-semibold text-[#521C0D] mb-2">Job Role</h4>
                          <p className="text-[#521C0D] opacity-80">{job.title.split('-')[0].trim()}</p>
                        </div>

                        <div className="mb-6">
                          <h4 className="font-semibold text-[#521C0D] mb-2">Job Description</h4>
                          <ul className="list-disc list-inside text-[#521C0D] opacity-80 space-y-1">
                        ...
                        <div>
                          <h4 className="font-semibold text-[#521C0D] mb-2">Experience</h4>
                          <p className="text-[#521C0D] opacity-80">{job.experience}</p>
                        </div>
                      </div>
                      ...
                      <div>
                        <div className="mb-6">
                          <h4 className="font-semibold text-[#521C0D] mb-2">Education Qualification</h4>
                          <p className="text-[#521C0D] opacity-80">{job.education}</p>
                        </div>

                        <div className="mb-6">
                          <h4 className="font-semibold text-[#521C0D] mb-2">Tech/Prof. Qualification</h4>
                          <p className="text-[#521C0D] opacity-80">{job.technical}</p>
                        </div>

                        <div>
                          <h4 className="font-semibold text-[#521C0D] mb-2">Skills</h4>
                          <ul className="list-disc list-inside text-[#521C0D] opacity-80 space-y-1">
                    ...
                    <div className="mt-8 flex justify-center">
                      <a
                        ...
                        className="inline-flex items-center gap-2 px-8 py-3 bg-[#521C0D] text-white hover:bg-[#521C0D] hover:opacity-90 transition-all rounded"
                      >
                        Apply Job
                      </a>
                    </div>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 text-center">
            <div className="flex items-center justify-center gap-3 mb-6">
              <Mail className="w-8 h-8 text-[#521C0D]" />
              <h2 className="text-3xl font-bold text-[#521C0D]">Apply Directly</h2>
            </div>
