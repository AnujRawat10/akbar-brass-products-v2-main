...
export default function About() {
  ...
  return (
    <section className="h-[100svh] bg-[#B8764F] pt-28 sm:pt-24 md:pt-24 pb-4 sm:pb-6 md:pb-8 flex flex-col justify-center overflow-hidden snap-start">
      {/* Header Section */}
...
About Akbar Brass Products</h2>
      ...
      <div className="text-center px-6">
        <div className="max-w-6xl mx-auto">
          <p className="text-white/90 text-sm md:text-base lg:text-lg leading-relaxed max-w-5xl mx-auto mb-3 md:mb-4">
in-house testing, and globally aligned compliance to deliver stable, export-ready quality.
          </p>

          <Link href="/about-akbar/timeline">
            <button className="group relative px-6 md:px-10 py-2 md:py-3 bg-white text-black overflow-hidden transition-all duration-500 uppercase tracking-wider font-medium text-sm md:text-base shadow-2xl hover:shadow-[#BF8B45]/50 transform hover:scale-105">
              {/* Button hover effect */}
