...
export default function DelhiFair() {
  return (
    <section className="bg-[#FAF6F2] h-[100svh] flex items-center justify-center text-black text-left pt-28 sm:pt-24 md:pt-24 pb-6 md:pb-8 overflow-hidden snap-start">
      <div className="w-full px-4 sm:px-6 lg:px-12">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-8 lg:gap-12 items-center">
          ...
          <div className="max-w-xl mx-auto lg:mx-0 text-center lg:text-left order-2 lg:order-1">
            <span className="uppercase tracking-[0.2em] md:tracking-[0.32em] text-xs md:text-sm text-[#AE7250] font-medium">
            ...
            <p className="text-black/70 text-base md:text-lg lg:text-xl leading-relaxed mb-2 md:mb-4">
            ...
            <p className="text-black/50 text-sm md:text-base lg:text-lg leading-relaxed hidden sm:block">
