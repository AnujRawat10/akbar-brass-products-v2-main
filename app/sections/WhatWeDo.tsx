...
export default function WhatWeDo() {
  ...
  return (
    <section className="h-[100svh] flex items-center bg-black text-white px-4 sm:px-6 pt-28 sm:pt-24 md:pt-24 pb-6 md:pb-8 overflow-hidden snap-start">
      <div className="max-w-6xl mx-auto w-full">
        <h2 className="font-serif mt-4 text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-center mb-2 md:mb-4">
          What We Do?
        </h2>
        <p className="text-center text-white/80 text-sm sm:text-base md:text-lg mb-4 md:mb-8 max-w-3xl mx-auto px-2">
          ...
          {materials.map((item) => (
            ...
            >
              ...
              <div className="relative z-10 h-full flex items-end p-3 sm:p-4 md:p-6">
                <h3 className="font-serif text-base sm:text-lg md:text-xl lg:text-2xl tracking-wide">
                  {item.title}
                </h3>
              </div>
        ...
        <div className="text-center">
          <Link href="/capabilities/portfolio">
