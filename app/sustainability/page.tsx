  ...
  return (
   ...
   <main >
        ...
        <section className="py-16 border-b border-[#521C0D] border-opacity-20">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-[#521C0D] mb-8">1. ENVIRONMENT</h2>

            {/* Responsible Resource Management */}
            <div className="mb-12">
              <div className="flex items-center gap-3 mb-6">
                <Droplets className="w-8 h-8 text-[#521C0D]" />
                <h3 className="text-2xl font-semibold text-[#521C0D]">Responsible Resource Management</h3>
              </div>
              <p className="text-[#521C0D] opacity-80 mb-4">
                Our integrated manufacturing campus is equipped with:
              </p>
              <ul className="list-disc list-inside text-[#521C0D] opacity-80 space-y-2 ml-4">
              ...
              <p className="text-[#521C0D] opacity-80 mt-4">
            ...
            <div className="mb-12">
              <div className="flex items-center gap-3 mb-6">
                <Wind className="w-8 h-8 text-[#521C0D]" />
                <h3 className="text-2xl font-semibold text-[#521C0D]">Cleaner Production</h3>
              </div>
              <p className="text-[#521C0D] opacity-80 mb-4">
            ...
            <div>
              <div className="flex items-center gap-3 mb-6">
                <Recycle className="w-8 h-8 text-[#521C0D]" />
                <h3 className="text-2xl font-semibold text-[#521C0D]">Recycling & Material Efficiency</h3>
              </div>
              <p className="text-[#521C0D] opacity-80 mb-4">
        ...
        <section className="py-16 bg-white border-b border-[#521C0D] border-opacity-20">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-[#521C0D] mb-8">2. COMMUNITY</h2>

            {/* Local Employment */}
            <div className="mb-12">
              <div className="flex items-center gap-3 mb-6">
                <Users className="w-8 h-8 text-[#521C0D]" />
                <h3 className="text-2xl font-semibold text-[#521C0D]">Local Employment & Skill Development</h3>
              </div>
              <p className="text-[#521C0D] opacity-80 mb-4">
            ...
            <div>
              <div className="flex items-center gap-3 mb-6">
                <GraduationCap className="w-8 h-8 text-[#521C0D]" />
                <h3 className="text-2xl font-semibold text-[#521C0D]">Education & Capability Building</h3>
              </div>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-[#521C0D] mb-8">3. WELLBEING</h2>

            {/* Safe & Ethical Workplace */}
            <div className="mb-12">
              <div className="flex items-center gap-3 mb-6">
                <Heart className="w-8 h-8 text-[#521C0D]" />
                <h3 className="text-2xl font-semibold text-[#521C0D]">Safe & Ethical Workplace</h3>
              </div>
              <p className="text-[#521C0D] opacity-80 mb-4">
            ...
            {/* Health & Awareness */}
            <div>
              <h3 className="text-2xl font-semibold text-[#521C0D] mb-4">Health & Awareness</h3>
              <p className="text-[#521C0D] opacity-80">
